...
Io, C, Rust, JavaScript, Shell, HTML, Dockerfile, VimScript, SuperCollider, Objective-C, CSS, XML, WGSL, TypeScript, Slint, Python, Nix, Makefile, Lua, Java, EmacsLisp, C++.
...
- [rust-query](https://github.com/LHolten/rust-query)
