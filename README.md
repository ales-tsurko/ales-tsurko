...
Io, C, Rust, JavaScript, Shell, HTML, VimScript, Objective-C, Dockerfile, SuperCollider, Python, CSS, XML, Swift, Slint, Nix, Makefile, Lua, Java, GLSL, C++.
...
- [e-ink.nvim](https://github.com/alexxGmZ/e-ink.nvim)
