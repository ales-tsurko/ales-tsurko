...
Io, C, Rust, JavaScript, Shell, HTML, Dockerfile, VimScript, SuperCollider, Objective-C, CSS, XML, WGSL, TypeScript, Slint, Python, Nix, Makefile, Lua, Java, GLSL, EmacsLisp, C++.
...
- [pseudo3d](https://github.com/izabera/pseudo3d)
- [vim-glsl](https://github.com/tikhomirov/vim-glsl)
- [terse-cli](https://github.com/JeffrayZhang/terse-cli)
